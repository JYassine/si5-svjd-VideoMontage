...
public class VideoMontageSVJDFactoryImpl extends EFactoryImpl implements VideoMontageSVJDFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case VideoMontageSVJDPackage.SCROLLING_TEXT: return createScrollingText();
   ...
   */
  @Override
  public ScrollingText createScrollingText()
  {
    ScrollingTextImpl scrollingText = new ScrollingTextImpl();
