...
import org.xtext.svjd.videoMontageSVJD.VideoMontageSVJDFactory;
 ...
 * @generated
 */
public class VideoMontageSVJDPackageImpl extends EPackageImpl implements VideoMontageSVJDPackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  private EClass scrollingTextEClass = null;
   ...
   * @see org.xtext.svjd.videoMontageSVJD.VideoMontageSVJDPackage#eNS_URI
   * @see #init()
   * @generated
   */
  private VideoMontageSVJDPackageImpl()
  {
    super(eNS_URI, VideoMontageSVJDFactory.eINSTANCE);
  }
   ...
   *
   * <p>This method is used to initialize {@link VideoMontageSVJDPackage#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static VideoMontageSVJDPackage init()
  {
    if (isInited) return (VideoMontageSVJDPackage)EPackage.Registry.INSTANCE.getEPackage(VideoMontageSVJDPackage.eNS_URI);

    // Obtain or create and register package
    Object registeredVideoMontageSVJDPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
    VideoMontageSVJDPackageImpl theVideoMontageSVJDPackage = registeredVideoMontageSVJDPackage instanceof VideoMontageSVJDPackageImpl ? (VideoMontageSVJDPackageImpl)registeredVideoMontageSVJDPackage : new VideoMontageSVJDPackageImpl();

    isInited = true;

    // Create package meta-data objects
    theVideoMontageSVJDPackage.createPackageContents();

    // Initialize created meta-data
    theVideoMontageSVJDPackage.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theVideoMontageSVJDPackage.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(VideoMontageSVJDPackage.eNS_URI, theVideoMontageSVJDPackage);
    return theVideoMontageSVJDPackage;
  }
  ...
  {
    return (EReference)audioElementEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EAttribute getSubtitle_Duration()
  {
   ...
   */
  @Override
  public EReference getAudioClip_Startingmoment()
  {
   ...
   */
  @Override
  public EAttribute getTitle_Duration()
  {
  ...
  {
    return (EReference)relativeMomentEClass.getEStructuralFeatures().get(1);
  }
  ...
  {
    return (EAttribute)relativeMomentEClass.getEStructuralFeatures().get(2);
  }
   ...
   */
  @Override
  public EClass getScrollingText()
  {
    return scrollingTextEClass;
  }
   ...
   */
  @Override
  public EAttribute getScrollingText_Speed()
  {
    return (EAttribute)scrollingTextEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public VideoMontageSVJDFactory getVideoMontageSVJDFactory()
  {
    return (VideoMontageSVJDFactory)getEFactoryInstance();
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(subtitleEClass, SUBTITLE__DURATION);
    ...
    createEReference(audioClipEClass, AUDIO_CLIP__STARTINGMOMENT);
    ...
    createEAttribute(titleEClass, TITLE__DURATION);
    ...
    scrollingTextEClass = createEClass(SCROLLING_TEXT);
    createEAttribute(scrollingTextEClass, SCROLLING_TEXT__SPEED);
  ...
  public void initializePackageContents()
  {
    ...
    scrollingTextEClass.getESuperTypes().add(this.getAnimation());
    ...
    initEReference(getMovie_Videoelement(), this.getVideoElement(), null, "videoelement", null, 0, -1, Movie.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getMovie_VideoTimeline(), this.getVideoTimeLine(), null, "VideoTimeline", null, 0, 1, Movie.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getVideoTimeLine_Videos(), this.getVideoElement(), null, "videos", null, 0, -1, VideoTimeLine.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getSubtitle_Startingmoment(), this.getStartingMoment(), null, "startingmoment", null, 0, 1, Subtitle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSubtitle_Duration(), ecorePackage.getEDouble(), "duration", null, 0, 1, Subtitle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getSubtitle_Textarea(), this.getTextArea(), null, "textarea", null, 0, 1, Subtitle.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getAudioClip_Startingmoment(), this.getStartingMoment(), null, "startingmoment", null, 0, 1, AudioClip.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getTitle_Duration(), ecorePackage.getEDouble(), "duration", null, 0, 1, Title.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getTitle_Textarea(), this.getTextArea(), null, "textarea", null, 0, 1, Title.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getTransition_Audioelement(), this.getAudioElement(), null, "audioelement", null, 0, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(scrollingTextEClass, ScrollingText.class, "ScrollingText", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getScrollingText_Speed(), ecorePackage.getEDouble(), "speed", null, 0, 1, ScrollingText.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
