 ...
 * @generated
 */
public interface VideoMontageSVJDFactory extends EFactory
{
  /**
   ...
   * @generated
   */
  VideoMontageSVJDFactory eINSTANCE = org.xtext.svjd.videoMontageSVJD.impl.VideoMontageSVJDFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Video Element</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Video Element</em>'.
   * @generated
   */
  ...
  /**
   * Returns a new object of class '<em>Scrolling Text</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Scrolling Text</em>'.
   * @generated
   */
  ScrollingText createScrollingText();
   ...
   * @generated
   */
  VideoMontageSVJDPackage getVideoMontageSVJDPackage();

} //VideoMontageSVJDFactory
