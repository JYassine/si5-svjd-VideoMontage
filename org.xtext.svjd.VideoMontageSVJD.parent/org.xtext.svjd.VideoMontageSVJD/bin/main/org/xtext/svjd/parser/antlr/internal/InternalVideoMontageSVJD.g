 ...
 */
grammar InternalVideoMontageSVJD;
...
// Entry rule entryRuleVideoTimeLine
entryRuleVideoTimeLine returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getVideoTimeLineRule()); }
	iv_ruleVideoTimeLine=ruleVideoTimeLine
	{ $current=$iv_ruleVideoTimeLine.current; }
	EOF;

// Rule VideoTimeLine
ruleVideoTimeLine returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_ScrollingText_2.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
// Entry rule entryRuleScrollingText
entryRuleScrollingText returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getScrollingTextRule()); }
	iv_ruleScrollingText=ruleScrollingText
	{ $current=$iv_ruleScrollingText.current; }
	EOF;

// Rule ScrollingText
ruleScrollingText returns [EObject current=null]
@init {
	enterRule();
}
@after {
